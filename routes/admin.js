...
router.post('/verify-password', adminAuth, verifyPassword);

// Commission Management
router.get('/commissions', adminAuth, getAllCommissions);
router.put('/commissions/:id/status-manual', adminAuth, updateCommissionStatusManual);
